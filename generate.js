...
var settings = {
	...
	"C_Cpp.default.includePath": ["${workspaceFolder}/Genesis/src/"],
};
...
FS.writeFileSync("./.vscode/launch.json", JSON.stringify(launch, null, 4), {
	encoding: "utf-8",
});
FS.writeFileSync("./.vscode/tasks.json", JSON.stringify(tasks, null, 4), {
	encoding: "utf-8",
});
FS.writeFileSync("./.vscode/settings.json", JSON.stringify(settings, null, 4), {
	encoding: "utf-8",
});

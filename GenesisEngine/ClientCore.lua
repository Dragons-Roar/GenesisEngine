...
project("GenesisEngine-Client-Core-Test")
	kind "ConsoleApp"
	systemversion "latest"
	language "C++"
	cppdialect(cfg_cxxStandard)
	location "%{wks.location}/GenesisEngine/ClientCore/src/test/"
	...
	includedirs {
		includeDirs["GenesisEngine-Client-Core-Test"]
	}

	links {
		dependencies["GenesisEngine-Client-Core-Test"]
	}
